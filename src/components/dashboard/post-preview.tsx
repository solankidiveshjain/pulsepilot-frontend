...
function PostPreviewComponent({ post }: PostPreviewProps) {
  ...
  const platformClass = `platform-badge-${post.platform.toLowerCase()}`
...
export const PostPreview = memo(PostPreviewComponent)
