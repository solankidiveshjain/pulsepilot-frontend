import type { Comment, Post, CommentReply, Platform } from "@/types"
...
export const platformInfo: Record<Platform, { color: string; icon: string }> = {
  youtube: { color: "youtube", icon: "/youtube.png" },
  instagram: { color: "instagram", icon: "/instagram.png" },
  twitter: { color: "twitter", icon: "/twitter.png" },
  tiktok: { color: "tiktok", icon: "/tiktok.png" },
  facebook: { color: "facebook", icon: "/facebook.png" },
  linkedin: { color: "linkedin", icon: "/linkedin.png" },
}
